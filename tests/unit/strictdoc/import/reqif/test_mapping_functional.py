...
def test_mapping_functional_uid_positive(fixture_functional_correctreqifobject, fixture_functional_type_map,
    ...
    requirement = SpecObjectParser.parse(xml_object, fixture_functional_type_map,
                                         fixture_functional_relation_map)
...
def test_mapping_functional_uid_malformed(fixture_functional_malformed_uid, fixture_functional_type_map,
                                          fixture_functional_relation_map):
    ...
    with pytest.raises(ValueError):
        SpecObjectParser.parse(xml_object, fixture_functional_type_map,
                               fixture_functional_relation_map)
    # [/LLR001-T002]


def test_mapping_functional_uid_missing(fixture_functional_missing_uid, fixture_functional_type_map,
                                        fixture_functional_relation_map):
...
def test_mapping_functional_asil_positive(fixture_functional_correctreqifobject, fixture_functional_type_map,
                                          fixture_functional_relation_map):
    object_string_pos = fixture_functional_correctreqifobject
    xml_object = etree.fromstring(object_string_pos)
    requirement = SpecObjectParser.parse(xml_object, fixture_functional_type_map,
...
def test_mapping_functional_status_positive(fixture_functional_correctreqifobject, fixture_functional_type_map,
                                            fixture_functional_relation_map):
    object_string_pos = fixture_functional_correctreqifobject
    xml_object = etree.fromstring(object_string_pos)
    requirement = SpecObjectParser.parse(xml_object, fixture_functional_type_map,
...
def test_mapping_functional_title_positive(fixture_functional_correctreqifobject, fixture_functional_type_map,
                                           fixture_functional_relation_map):
    object_string_pos = fixture_functional_correctreqifobject
    xml_object = etree.fromstring(object_string_pos)
    requirement = SpecObjectParser.parse(xml_object, fixture_functional_type_map,
