...
def test_mapping_test_positive(fixture_test):
    ...
    # 2 test mapping
    spec_object = SpecObject.parse(xml_object, fixture_test)
    ...
    # [LLR208-T001]
    assert (
                spec_object.test_sequence == "The correct value for the requirement_ID shall be passed to the function and the function returns the same value as result and compares it to the predefined test value.")
    # [/LLR208-T001]
    # [LLR207-T001]
    ...
    # [LLR206-T101]
    assert (
                spec_object.objective == "The test function shall test the mapping of the ReqIF attribute requirement_ID to the SDoC attribute UID.")
    # [/LLR206-T101]
    # [LLR202-T001]
...
def test_mapping_test_negative(fixture_test):
    # 1 create testobject from string
    ...
    # parse object here
    xml_object = etree.fromstring(object_string_neg)

    with pytest.raises(ValueError, match="uid_malformed"):
        SpecObject.parse(xml_object, fixture_test)
